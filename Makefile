...
LD=link
LDFLAGS=/entry:RawEntryPoint /subsystem:windows /machine:x86 /release /merge:.rdata=.data /merge:.text=.data /filealign:512 /incremental:no /safeseh:no /fixed /opt:ref /opt:icf /ignore:4078
